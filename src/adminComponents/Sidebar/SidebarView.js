...
const structure = [
  { id: 0, label: 'User', link: '/admin/user', icon: <ContactsIcon /> },
  { id: 1, label: 'Post', link: '/admin/post', icon: <EmailIcon /> },
  { id: 2, label: 'Group', link: '/admin/group', icon: <GroupIcon /> },
  { id: 3, label: 'Forum', link: '/admin/forum', icon: <ForumIcon />},
  { id: 4, type: 'divider' },
